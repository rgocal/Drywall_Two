...
public class CategoryTwoAdapter extends RecyclerView.Adapter<CategoryTwoAdapter.ViewHolder> {
    ...
    public CategoryTwoAdapter(ArrayList<Article> list, int rowLayout, Context context) {
    ...
    @Override
    public CategoryTwoAdapter.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View v = LayoutInflater.from(viewGroup.getContext()).inflate(rowLayout, viewGroup, false);
        return new CategoryTwoAdapter.ViewHolder(v);
    }

    @Override
    public void onBindViewHolder(final CategoryTwoAdapter.ViewHolder viewHolder, final int position) {

        SettingsProvider.get(mContext)
                .edit()
                .putInt("categoryTwoCount", getItemCount())
                .apply();
