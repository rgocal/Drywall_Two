...
import sapphyx.gsd.com.drywall.adapters.CategoryTenAdapter;
...
public class CollectionsTen extends Fragment {
    ...
    private CategoryTenAdapter mAdapter;
    private SwipeRefreshLayout mSwipeRefreshLayout;
    private ProgressBar progressBar;
    private String urlString = "https://raw.githubusercontent.com/rgocal/Drywall_Two/master/WallpaperFeeds/Seasons.rss";
    ...
    public CollectionsTen() {
    }

    public static CollectionsTen newInstance(int instance) {
        Bundle args = new Bundle();
        args.putInt(ARGS_INSTANCE, instance);
        CollectionsTen fragment = new CollectionsTen();
    ...
    public void loadFeed() {
        ...
        parser.onFinish(new Parser.OnTaskCompleted() {
            ...
            public void onTaskCompleted(ArrayList<Article> list) {
                ...
                mAdapter = new CategoryTenAdapter(list, R.layout.collection_category_item, getActivity());
