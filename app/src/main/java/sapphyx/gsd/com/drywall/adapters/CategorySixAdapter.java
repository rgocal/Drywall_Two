...
public class CategorySixAdapter extends RecyclerView.Adapter<CategorySixAdapter.ViewHolder> {
    ...
    public CategorySixAdapter(ArrayList<Article> list, int rowLayout, Context context) {
    ...
    @Override
    public CategorySixAdapter.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View v = LayoutInflater.from(viewGroup.getContext()).inflate(rowLayout, viewGroup, false);
        return new CategorySixAdapter.ViewHolder(v);
    }

    @Override
    public void onBindViewHolder(final CategorySixAdapter.ViewHolder viewHolder, final int position) {

        SettingsProvider.get(mContext)
                .edit()
                .putInt("categorySixCount", getItemCount())
                .apply();
