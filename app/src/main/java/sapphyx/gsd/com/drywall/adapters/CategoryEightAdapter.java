...
public class CategoryEightAdapter extends RecyclerView.Adapter<CategoryEightAdapter.ViewHolder> {
    ...
    public CategoryEightAdapter(ArrayList<Article> list, int rowLayout, Context context) {
    ...
    @Override
    public CategoryEightAdapter.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View v = LayoutInflater.from(viewGroup.getContext()).inflate(rowLayout, viewGroup, false);
        return new CategoryEightAdapter.ViewHolder(v);
    }
    ...
    public void onBindViewHolder(final ViewHolder viewHolder, final int position) {
        ...
        SettingsProvider.get(mContext)
                .edit()
                .putInt("categoryEightCount", getItemCount())
                .apply();
