...
import sapphyx.gsd.com.drywall.adapters.CategoryEightAdapter;
...
public class CollectionsEight extends Fragment {
    ...
    private CategoryEightAdapter mAdapter;
    private SwipeRefreshLayout mSwipeRefreshLayout;
    private ProgressBar progressBar;
    private String urlString = "https://raw.githubusercontent.com/rgocal/Drywall_Two/master/WallpaperFeeds/Pixel.rss";
    ...
    public void loadFeed() {
        ...
        parser.onFinish(new Parser.OnTaskCompleted() {
            ...
            public void onTaskCompleted(ArrayList<Article> list) {
                ...
                mAdapter = new CategoryEightAdapter(list, R.layout.collection_category_item, getActivity());
