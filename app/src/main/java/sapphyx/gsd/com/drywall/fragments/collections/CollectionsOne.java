...
import sapphyx.gsd.com.drywall.adapters.CategoryOneAdapter;
...
public class CollectionsOne extends Fragment {
    ...
    private CategoryOneAdapter mAdapter;
    private SwipeRefreshLayout mSwipeRefreshLayout;
    private ProgressBar progressBar;
    private String urlString = "https://gocalsdb.wordpress.com/category/FeaturedWallpaper/feed/";
    ...
    public void loadFeed() {
        ...
        parser.onFinish(new Parser.OnTaskCompleted() {
            ...
            public void onTaskCompleted(ArrayList<Article> list) {
                ...
                mAdapter = new CategoryOneAdapter(list, R.layout.collection_category_item, getActivity());
