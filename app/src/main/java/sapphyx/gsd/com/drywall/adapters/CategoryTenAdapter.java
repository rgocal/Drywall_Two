...
public class CategoryTenAdapter extends RecyclerView.Adapter<CategoryTenAdapter.ViewHolder> {
    ...
    public CategoryTenAdapter(ArrayList<Article> list, int rowLayout, Context context) {
    ...
    @Override
    public CategoryTenAdapter.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View v = LayoutInflater.from(viewGroup.getContext()).inflate(rowLayout, viewGroup, false);
        return new CategoryTenAdapter.ViewHolder(v);
    }

    @Override
    public void onBindViewHolder(final CategoryTenAdapter.ViewHolder viewHolder, final int position) {

        SettingsProvider.get(mContext)
                .edit()
                .putInt("categoryTenCount", getItemCount())
                .apply();
