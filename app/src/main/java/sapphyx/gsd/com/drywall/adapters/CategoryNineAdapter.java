...
public class CategoryNineAdapter extends RecyclerView.Adapter<CategoryNineAdapter.ViewHolder> {
    ...
    public CategoryNineAdapter(ArrayList<Article> list, int rowLayout, Context context) {
    ...
    @Override
    public CategoryNineAdapter.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View v = LayoutInflater.from(viewGroup.getContext()).inflate(rowLayout, viewGroup, false);
        return new CategoryNineAdapter.ViewHolder(v);
    }

    @Override
    public void onBindViewHolder(final CategoryNineAdapter.ViewHolder viewHolder, final int position) {

        SettingsProvider.get(mContext)
                .edit()
                .putInt("categoryNineCount", getItemCount())
                .apply();
