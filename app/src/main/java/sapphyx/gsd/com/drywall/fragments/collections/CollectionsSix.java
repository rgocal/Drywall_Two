...
import sapphyx.gsd.com.drywall.adapters.CategorySixAdapter;
...
public class CollectionsSix extends Fragment {
    ...
    private CategorySixAdapter mAdapter;
    private SwipeRefreshLayout mSwipeRefreshLayout;
    private ProgressBar progressBar;
    private String urlString = "https://raw.githubusercontent.com/rgocal/Drywall_Two/master/WallpaperFeeds/Cityscapes.rss";
    ...
    public CollectionsSix() {
    }

    public static CollectionsSix newInstance(int instance) {
        Bundle args = new Bundle();
        args.putInt(ARGS_INSTANCE, instance);
        CollectionsSix fragment = new CollectionsSix();
    ...
    public void loadFeed() {
        ...
        parser.onFinish(new Parser.OnTaskCompleted() {
            ...
            public void onTaskCompleted(ArrayList<Article> list) {
                ...
                mAdapter = new CategorySixAdapter(list, R.layout.collection_category_item, getActivity());
