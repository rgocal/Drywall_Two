...
public class CategoryFourAdapter extends RecyclerView.Adapter<CategoryFourAdapter.ViewHolder> {
    ...
    public CategoryFourAdapter(ArrayList<Article> list, int rowLayout, Context context) {
    ...
    @Override
    public CategoryFourAdapter.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View v = LayoutInflater.from(viewGroup.getContext()).inflate(rowLayout, viewGroup, false);
        return new CategoryFourAdapter.ViewHolder(v);
    }

    @Override
    public void onBindViewHolder(final CategoryFourAdapter.ViewHolder viewHolder, final int position) {

        SettingsProvider.get(mContext)
                .edit()
                .putInt("categoryFourCount", getItemCount())
                .apply();
