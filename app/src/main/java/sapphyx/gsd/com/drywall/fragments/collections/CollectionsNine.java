...
import sapphyx.gsd.com.drywall.adapters.CategoryNineAdapter;
...
public class CollectionsNine extends Fragment {
    ...
    private CategoryNineAdapter mAdapter;
    private SwipeRefreshLayout mSwipeRefreshLayout;
    private ProgressBar progressBar;
    private String urlString = "https://raw.githubusercontent.com/rgocal/Drywall_Two/master/WallpaperFeeds/Earth.rss";
    ...
    public CollectionsNine() {
    }

    public static CollectionsNine newInstance(int instance) {
        Bundle args = new Bundle();
        args.putInt(ARGS_INSTANCE, instance);
        CollectionsNine fragment = new CollectionsNine();
    ...
    public void loadFeed() {
        ...
        parser.onFinish(new Parser.OnTaskCompleted() {
            ...
            public void onTaskCompleted(ArrayList<Article> list) {
                ...
                mAdapter = new CategoryNineAdapter(list, R.layout.collection_category_item, getActivity());
