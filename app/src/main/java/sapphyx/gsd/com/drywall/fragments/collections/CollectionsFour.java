...
import sapphyx.gsd.com.drywall.adapters.CategoryFourAdapter;
...
public class CollectionsFour extends Fragment {
    ...
    private CategoryFourAdapter mAdapter;
    private SwipeRefreshLayout mSwipeRefreshLayout;
    private ProgressBar progressBar;
    private String urlString = "https://raw.githubusercontent.com/rgocal/Drywall_Two/master/WallpaperFeeds/OEM.rss";
    ...
    public CollectionsFour() {
    }

    public static CollectionsFour newInstance(int instance) {
        Bundle args = new Bundle();
        args.putInt(ARGS_INSTANCE, instance);
        CollectionsFour fragment = new CollectionsFour();
    ...
    public void loadFeed() {
        ...
        parser.onFinish(new Parser.OnTaskCompleted() {
            ...
            public void onTaskCompleted(ArrayList<Article> list) {
                ...
                mAdapter = new CategoryFourAdapter(list, R.layout.collection_category_item, getActivity());
