...
public class CategorySevenAdapter extends RecyclerView.Adapter<CategorySevenAdapter.ViewHolder> {
    ...
    public CategorySevenAdapter(ArrayList<Article> list, int rowLayout, Context context) {
    ...
    @Override
    public CategorySevenAdapter.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View v = LayoutInflater.from(viewGroup.getContext()).inflate(rowLayout, viewGroup, false);
        return new CategorySevenAdapter.ViewHolder(v);
    }

    @Override
    public void onBindViewHolder(final CategorySevenAdapter.ViewHolder viewHolder, final int position) {

        SettingsProvider.get(mContext)
                .edit()
                .putInt("categorySevenCount", getItemCount())
                .apply();
