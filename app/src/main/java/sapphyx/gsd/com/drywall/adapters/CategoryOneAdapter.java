...
public class CategoryOneAdapter extends RecyclerView.Adapter<CategoryOneAdapter.ViewHolder> {
    ...
    public CategoryOneAdapter(ArrayList<Article> list, int rowLayout, Context context) {
    ...
    @Override
    public CategoryOneAdapter.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View v = LayoutInflater.from(viewGroup.getContext()).inflate(rowLayout, viewGroup, false);
        return new CategoryOneAdapter.ViewHolder(v);
    }

    @Override
    public void onBindViewHolder(final CategoryOneAdapter.ViewHolder viewHolder, final int position) {

        SettingsProvider.get(mContext)
                .edit()
                .putInt("categoryOneCount", getItemCount())
                .apply();
