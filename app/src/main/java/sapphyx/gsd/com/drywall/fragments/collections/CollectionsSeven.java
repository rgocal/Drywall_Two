...
import sapphyx.gsd.com.drywall.adapters.CategorySevenAdapter;
...
public class CollectionsSeven extends Fragment {
    ...
    private CategorySevenAdapter mAdapter;
    private SwipeRefreshLayout mSwipeRefreshLayout;
    private ProgressBar progressBar;
    private String urlString = "https://raw.githubusercontent.com/rgocal/Drywall_Two/master/WallpaperFeeds/Life.rss";
    ...
    public CollectionsSeven() {
    }

    public static CollectionsSeven newInstance(int instance) {
        Bundle args = new Bundle();
        args.putInt(ARGS_INSTANCE, instance);
        CollectionsSeven fragment = new CollectionsSeven();
    ...
    public void loadFeed() {
        ...
        parser.onFinish(new Parser.OnTaskCompleted() {
            ...
            public void onTaskCompleted(ArrayList<Article> list) {
                ...
                mAdapter = new CategorySevenAdapter(list, R.layout.collection_category_item, getActivity());
