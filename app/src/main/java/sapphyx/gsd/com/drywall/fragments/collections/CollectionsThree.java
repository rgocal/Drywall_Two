...
import sapphyx.gsd.com.drywall.adapters.CategoryThreeAdapter;
...
public class CollectionsThree extends Fragment {
    ...
    private String urlString = "https://raw.githubusercontent.com/rgocal/Drywall_Two/master/WallpaperFeeds/Environments.rss";
    ...
    public CollectionsThree() {
    }

    public static CollectionsThree newInstance(int instance) {
        Bundle args = new Bundle();
        args.putInt(ARGS_INSTANCE, instance);
        CollectionsThree fragment = new CollectionsThree();
    ...
    public void loadFeed() {
        ...
        parser.onFinish(new Parser.OnTaskCompleted() {
            ...
            public void onTaskCompleted(ArrayList<Article> list) {
                ...
                mAdapter = new CategoryThreeAdapter(list, R.layout.collection_category_item, getActivity());
