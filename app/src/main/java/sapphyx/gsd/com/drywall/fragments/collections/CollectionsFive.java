...
import sapphyx.gsd.com.drywall.adapters.CategoryFiveAdapter;
...
public class CollectionsFive extends Fragment {
    ...
    private CategoryFiveAdapter mAdapter;
    private SwipeRefreshLayout mSwipeRefreshLayout;
    private ProgressBar progressBar;
    private String urlString = "https://raw.githubusercontent.com/rgocal/Drywall_Two/master/WallpaperFeeds/Colors.rss";
    ...
    public CollectionsFive() {
    }

    public static CollectionsFive newInstance(int instance) {
        Bundle args = new Bundle();
        args.putInt(ARGS_INSTANCE, instance);
        CollectionsFive fragment = new CollectionsFive();
    ...
    public void loadFeed() {
        ...
        parser.onFinish(new Parser.OnTaskCompleted() {
            ...
            public void onTaskCompleted(ArrayList<Article> list) {
                ...
                mAdapter = new CategoryFiveAdapter(list, R.layout.collection_category_item, getActivity());
